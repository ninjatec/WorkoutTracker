...
namespace WorkoutTrackerWeb.Areas.Coach.Pages.Templates
{
    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            // Verify ownership if template is not public
            if (!existingTemplate.IsPublic)
            {
                ...
                if (coachUser == null || existingTemplate.UserId != coachUser.UserId)
                {
                    return Forbid();
                }
            }
        ...
        public async Task<IActionResult> OnPostAddExerciseAsync(int templateId, int exerciseTypeId, int sequenceNum, string notes)
        {
            ...
            if (!template.IsPublic)
            {
                ...
                if (coachUser == null || template.UserId != coachUser.UserId)
                {
                    return Forbid();
                }
            }
