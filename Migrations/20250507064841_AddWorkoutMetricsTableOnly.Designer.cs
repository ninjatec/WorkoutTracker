...
namespace WorkoutTrackerWeb.Migrations
{
    ...
    [Migration("20250507064841_AddWorkoutMetricsTableOnly")]
    partial class AddWorkoutMetricsTableOnly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutTrackerWeb.Models.Coaching.WorkoutSchedule", b =>
                {
                    ...
                    b.HasIndex("LastGeneratedSessionId")
                        .IsUnique()
                        .HasFilter("[LastGeneratedSessionId] IS NOT NULL");
            ...
            modelBuilder.Entity("WorkoutTrackerWeb.Models.WorkoutMetric", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("UserId", "Date", "MetricType")
                        .IsUnique();

                    b.ToTable("WorkoutMetrics");
                });
            ...
            modelBuilder.Entity("WorkoutTrackerWeb.Models.Coaching.WorkoutSchedule", b =>
                {
                    ...
                    b.HasOne("WorkoutTrackerWeb.Models.WorkoutSession", "LastGeneratedSession")
                        .WithOne()
                        .HasForeignKey("WorkoutTrackerWeb.Models.Coaching.WorkoutSchedule", "LastGeneratedSessionId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("WorkoutTrackerWeb.Models.WorkoutSession", b =>
                {
                    ...
                    b.HasOne("WorkoutTrackerWeb.Models.Coaching.WorkoutSchedule", "Schedule")
                        .WithMany()
